...
const it = {
  ...
  "territories.diagnosticBody":
    "StoreKit non ha restituito uno o più prodotti configurati. Questi dati identificano il punto esatto del problema.",
  ...
  "territories.diagnosticProduct": "Product ID richiesti: %{productId}",
...
const en: Record<TranslationKey, string> = {
  ...
  "territories.diagnosticBody":
    "StoreKit did not return one or more configured products. These details identify where the failure occurs.",
  ...
  "territories.diagnosticProduct": "Requested product IDs: %{productId}",
...
const fr: Record<TranslationKey, string> = {
  ...
  "territories.diagnosticBody":
    "StoreKit n’a pas renvoyé un ou plusieurs produits configurés. Ces données permettent d’identifier précisément le problème.",
  ...
  "territories.diagnosticProduct": "Product IDs demandés : %{productId}",
...
const de: Record<TranslationKey, string> = {
  ...
  "territories.diagnosticBody":
    "StoreKit hat ein oder mehrere konfigurierte Produkte nicht zurückgegeben. Diese Angaben zeigen die genaue Fehlerstelle.",
  ...
  "territories.diagnosticProduct": "Angeforderte Product IDs: %{productId}",

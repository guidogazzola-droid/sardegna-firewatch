...
const messages = {
  ...
  fr: {
    ...
    testTitle: "Sabetta Piro — notifications actives",
    testBody:
    ...
    detectionTitle: "Sabetta Piro — détection satellitaire",
